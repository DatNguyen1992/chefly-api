...
let EmailController = class EmailController {
    ...
    async handleWebhook(body) {
        try {
            ...
            const { recipient = 'test123@sandbox1640064e04114303ac6dbb770cb34e1a.mailgun.org', sender = 'no-reply@example.com', subject = 'Test Subject', 'stripped-text': textContent = 'Test Content', 'body-html': htmlContent, } = body;
